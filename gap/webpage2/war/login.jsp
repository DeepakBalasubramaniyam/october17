...
<div class="jumbotron">
    ...
    <div class="navbar-header">
         ...
         <div>
              <ul class="nav navbar-nav">
                 ...
                 <li><a href="http://www.adaptavant.com/innovations">Innovations</a></li>
                 ...
                 <li   class="active"class="active"><a href="#">Login</a></li>
              </ul>
         </div>
    </div>
 </nav>
 ...
 <div class="container">
  <h2>Login form</h2>
  <p>Enter the username and password of the account:</p>
